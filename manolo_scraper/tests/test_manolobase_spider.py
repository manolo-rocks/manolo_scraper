...
class TestManoloBaseSpider(unittest.TestCase):
    ...
    def setUp(self):
        self.spider = ManoloBaseSpider(name='manolo')
    ...
    def test_get_date_item(self):
        self.assertEqual(self.spider.get_date_item('2015/08/20', '%Y/%m/%d'), '2015-08-20')

    def test_days_between_dates(self):
        self.assertEqual(self.spider.days_between_dates('2015-08-20', '2015-08-30'), 10)
        self.assertEqual(self.spider.days_between_dates('2015-08-30', '2015-08-20'), -10)
        self.assertEqual(self.spider.days_between_dates('2015-08-30', '2015-08-30'), 0)
